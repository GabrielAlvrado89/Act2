      ...
      body: Container(
        ...
        child: Stack(
          children: [
            ...
            Positioned(
              top: size.height * 0.45, // Adjusted to move content higher
              left: 0,
              right: 0,
              child: Center(
                child: Column(
                  children: [
                    ...
                    Text(
                      "Explora todos nuestros sabores\nque hacemos solo para ti",
                      textAlign: TextAlign.center,
                      style: TextStyle(
                        fontSize: 18,
                        color: textColor2,
                    ...
                    SizedBox(height: size.height * 0.05), // Slightly reduced spacing
                    Padding(
